      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <Link
            ...
            to="#activity"
            onClick={(e) => {e.preventDefault(); handleTabChange('activity')}}
            data-toggle="tab"
          >
            Activity
          </Link>
        ...
        <li className="nav-item">
          <Link
            ...
            to="#timeline"
            onClick={(e) =>{ e.preventDefault(); handleTabChange('timeline')}}
            data-toggle="tab"
          >
            Timeline
          </Link>
          ...
          >
            Settings
              ...
              <div className="tab-content">
                {activeTab === 'activity' && <div id="activity" className={`tab-pane fade ${activeTab === 'activity' ? 'show active' : ''}`}>
                <div class="post">
                ...
                {activeTab === 'timeline' && <div id="timeline" className={`tab-pane fade ${activeTab === 'timeline' ? 'show active' : ''}`}>
                ...
                {activeTab === 'settings' && <div id="settings" className={`tab-pane fade ${activeTab === 'settings' ? 'show active' : ''}`}>
                <form class="form-horizontal">
